...
public static class Initialization
{
    ...
    private static void CreateEngineer()
    {
        ...
        (string, string)[] engineerNameAndEmailTuple =
        {
            ...
            ("Casey Bennett","casey.bennett@example.com"),
            ("Morgan Hayes","morgan.hayes@example.com"),
            ("Riley Foster","riley.foster@example.com"),
            ("Cameron Brooks","cameron.brooks@example.com"),
            ("Avery Parker","avery.parker@example.com"),
            ("Jamie Collins","jamie.collins@example.com"),
            ("Drew Sullivan","drew.sullivan@example.com")
        };
        //
        for (int i = 0; i < 4; i++)
        {
